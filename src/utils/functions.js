...
export const createURL = {
  forecast: function (str){ return('http://api.openweathermap.org/data/2.5/forecast?q=' + str +'&units=metric&appid=da16d6de03fba61dd8b294b58864d4b7')},
  weather: function (str){ return('http://api.openweathermap.org/data/2.5/weather?q=' + str +'&units=metric&appid=da16d6de03fba61dd8b294b58864d4b7')},
  group:function (arr){
    
    let ids ='';
    arr.forEach((item)=>{ids = ids + ',' + item[1]});
    ids = ids.slice(1);
    const result = 'http://api.openweathermap.org/data/2.5/group?id='+ ids +'&units=metric&appid=da16d6de03fba61dd8b294b58864d4b7';
    return result;
  }
}
